...
pass. The owner-approved legal/privacy and single-VPS production profile is recorded. Public release
still requires validation on the actual Hostinger deployment plus physical assistive-technology
review. Hosted CI is green on the frozen release candidate. See the
